...
function AllureLogo() {
  return (
    <svg viewBox="0 0 260 150" className="h-6 w-auto" role="img" aria-label="Allure Aesthetics">
...
function BusinessAdvantageLogo() {
  return (
    <svg viewBox="0 0 250 72" className="h-4 w-auto" role="img" aria-label="Business Advantage">
...
function WegaLogo() {
  return (
    <svg viewBox="0 0 300 84" className="h-4 w-auto" role="img" aria-label="Wega Pharmacy">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 items-stretch">
      {PARTNERS.map(({ name, Logo }) => (
        <div
          key={name}
          title={name}
          className="flex items-center justify-center bg-white rounded-2xl p-3 shadow-soft min-h-[48px]"
        >
          <Logo />
        </div>
      ))}
