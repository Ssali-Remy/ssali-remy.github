...
export const units = [
  {
    ...
    location: "Kansanga",
    locationId: "kansanga",
    tagline: "Three-bedroom wing of the duplex on Kansanga hill",
    bedrooms: 3,
    bathrooms: 2,
    sleeps: 6,
  ...
  },
  {
    ...
    location: "Kansanga",
    locationId: "kansanga",
    tagline: "The entire duplex — Units One & Two combined, ideal for big groups",
    bedrooms: 5,
    bathrooms: 4,
    sleeps: 10,
  ...
  },
  {
    ...
    location: "Munyonyo",
    locationId: "munyonyo",
    tagline: "All three Munyonyo apartments together — the whole compound",
    bedrooms: 5,
    bathrooms: 5,
    sleeps: 10,
