// Shared "House Guide" list from the welcome booklet — used on the home
// page, every location page and every individual apartment page.
...
// Back-compat alias.
export const HOUSE_RULES = HOUSE_GUIDE;
